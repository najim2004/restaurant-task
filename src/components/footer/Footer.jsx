    ...
    <footer className="relative py-[120px] text-white">
      ...
      <Container>
        ...
        <div className="relative z-10 container mx-auto px-4">
          {/* Heading */}
          <h2 className="text-[62px] font-medium text-center mb-12 font-bebas mx-auto">
            WE READY TO HAVE YOU THE BEST DINING EXPERIENCES
          </h2>

          {/* Info Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-[120px]">
            {/* Opening Hours */}
          ...
          <div className="flex justify-center gap-4 mb-6">
            <Link
              to="#"
              className="size-[53px] border border-white rounded-full flex items-center justify-center hover:bg-white/10 transition-colors"
            >
              <img src={facebook} className="size-6" />
            </Link>
            <Link
              to="#"
              className="size-[53px] border border-white rounded-full flex items-center justify-center hover:bg-white/10 transition-colors"
            >
              <img src={twitter} className="size-6" />
            </Link>
            <Link
              to="#"
              className="size-[53px] border border-white rounded-full flex items-center justify-center hover:bg-white/10 transition-colors"
